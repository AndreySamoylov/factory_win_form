...
namespace WindowsFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private void toolStripButtonOrderReport_Click(object sender, EventArgs e)
        {
            // Функциональность создания отчета по деталям
            // Создаем объект Word.Application
            Word.Application wordApp = new Word.Application();
            ...
            try
            {
                // Добавление заголовка в документ
                Word.Paragraph paragraph = wordDoc.Content.Paragraphs.Add();
                paragraph.Range.Text = "Отчет по заказам";
                paragraph.Range.Font.Bold = 1;
                paragraph.Format.SpaceAfter = 10;
                paragraph.Range.InsertParagraphAfter();
                ...
                var dataTable = inform_system_baseDataSet.ПредставлениеЗаказы;
        ...
        private void toolStripButtonPaymentsReport_Click(object sender, EventArgs e)
        {
            // Функциональность создания отчета по деталям
            // Создаем объект Word.Application
            Word.Application wordApp = new Word.Application();
            ...
            try
            {
                // Добавление заголовка в документ
                Word.Paragraph paragraph = wordDoc.Content.Paragraphs.Add();
                paragraph.Range.Text = "Отчет по оплатам";
                paragraph.Range.Font.Bold = 1;
                paragraph.Format.SpaceAfter = 10;
                paragraph.Range.InsertParagraphAfter();
                ...
                var dataTable = inform_system_baseDataSet.ПредставлениеОплаты;
